...
<section class="section-padding" style="margin-top: 9vh ;">
    <div class="section-header text-center">
        <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">Edit Kriteria</h2>
            ...
            <div class="row justify-content-between align-items-center p-3">
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name"
                        value="{{ old('name', $kriteria->name) }}" required>
                    @if ($errors->has('name'))
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    ...
                    <input class="form-control @error('description') is-invalid @enderror" type="text"
                        name="description" id="description" value="{{ old('description', $kriteria->description) }}">
                ...
                {{-- <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    ...
                    <select class="form-control @error('department_id') is-invalid @enderror" name="department_id"
                        ...
                        <option value="{{ $department->id }}" {{ old('department_id', $kriteria->department_id) == $department->id ? 'selected' : '' }}>{{ $department->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    ...
                    <div class="input-group">
                        <select class="form-control @error('icon') is-invalid @enderror" name="icon" id="icon">
                            ...
                            <option value="{{ $icon }}" {{ old('icon', $kriteria->icon) == $icon ? 'selected' : '' }}>{{ $icon }}</option>
                            @endforeach
                        </select>
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <i id="icon-preview" class="bi bi-{{ old('icon', $kriteria->icon) }}"></i>
                            </span>
                        </div>
                    </div>
                    @if ($errors->has('icon'))
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    <img id="image-preview" src="{{ $kriteria->image ? asset('storage/' . $kriteria->image) : '#' }}" alt="Image Preview"
                        style="display: {{ $kriteria->image ? 'block' : 'none' }}; max-width: 100%; height: auto; margin-top: 10px;">
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
